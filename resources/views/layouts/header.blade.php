...
<li class="l-drawer__item">
<div class="row mx-0 l-drawer__app">
<a class="col p-0 text-white" href="{{ route('ga-report', $site_id) }}">レポートを作成する</a>
<a class="col p-0 text-white" href="{{ route('seo-report', $site_id) }}">SEO分析する</a>
</div>
</li>
