...
<button type="submit" class="btn btn-primary" onclick="gtag('event', 'click', {'event_category': 'register','event_label': 'next'});gtag('event', 'conversion', {'send_to': 'AW-672878991/Lv9ECK-S9MUBEI-j7cAC'});">{{ __('Register') }}</button>
</div>
</form>
</div>
</section>
